...
import com.shoesstore.service.utility.SecurityUtility;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLİC_MATCHERS = { "/css/**", "/js/**", "/image/**", "/", "/myAccount" };

	@Override
	protected void configure(HttpSecurity http) throws Exception {

		http.authorizeRequests()./* antMatchers("/**"). */antMatchers(PUBLİC_MATCHERS).permitAll().anyRequest()
				.authenticated();
